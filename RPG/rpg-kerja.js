...
switch(type) {
	case 'ojek':
	if (global.db.data.users[m.sender].ojek == false) throw m.reply('ni bukan tugas kamu atau kamu pengangguran!')
if (new Date - global.db.data.users[m.sender].lastkerja < 300000)  throw m.reply(`Kamu sudah bekerja\nSaatnya istirahat selama ${clockString(time - new Date())}`)
...
break
     case 'pedagang':
     if (global.db.data.users[m.sender].pedagang == false) throw m.reply('ni bukan tugas kamu atau kamu pengangguran!')
if (new Date - global.db.data.users[m.sender].lastkerja < 300000)  throw m.reply(`Kamu sudah bekerja\nSaatnya istirahat selama ${clockString(time - new Date())}`)
...
break
      case 'dokter':
 if (global.db.data.users[m.sender].dokter == false) throw m.reply('ni bukan tugas kamu atau kamu pengangguran!')
if (new Date - global.db.data.users[m.sender].lastkerja < 300000)  throw m.reply(`Kamu sudah bekerja\nSaatnya istirahat selama ${clockString(time - new Date())}`)
...
break
       case 'petani':
if (global.db.data.users[m.sender].petani == false) throw m.reply('ni bukan tugas kamu atau kamu pengangguran!')
if (new Date - global.db.data.users[m.sender].lastkerja < 300000)  throw m.reply(`Kamu sudah bekerja\nSaatnya istirahat selama ${clockString(time - new Date())}`)
	global.db.data.users[m.sender].atm += uangm
global.db.data.users[m.sender].lastkerja = new Date * 1
...
break
     case 'montir':
 if (global.db.data.users[m.sender].montir == false) throw m.reply('ni bukan tugas kamu atau kamu pengangguran!')
if (new Date - global.db.data.users[m.sender].lastkerja < 300000)  throw m.reply(`Kamu sudah bekerja\nSaatnya istirahat selama ${clockString(time - new Date())}`)
...
break
      case 'kuli':
 if (global.db.data.users[m.sender].kuli == false) throw m.reply('ni bukan tugas kamu atau kamu pengangguran!')
if (new Date - global.db.data.users[m.sender].lastkerja < 300000)  throw m.reply(`Kamu sudah bekerja\nSaatnya istirahat selama ${clockString(time - new Date())}`)

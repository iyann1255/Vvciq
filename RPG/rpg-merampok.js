...
let nomors = m.sender
  ...
  if (!who) throw m.reply('Tag salah satu lah')
  if (typeof db.data.users[who] == 'undefined') throw m.reply('Pengguna tidak ada didalam data base')
  ...
  if (10000 > users[who].money) throw m.reply('ᴛᴀʀɢᴇᴛ ɢᴀᴀᴅᴀ 💰ᴜᴀɴɢ ʙᴏᴅᴏʜ, ᴋɪꜱᴍɪɴ ᴅɪᴀ')

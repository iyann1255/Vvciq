...
${ usedPrefix }cook`    
        setTimeout(() => {
        conn.sendText(m.chat, mcng, m)
         if (psepick > 0 ) {
         	pengguna.psepick += psepick * 1
         	conn.sendText(m.chat, `You Get 🎁chest weapons epic ${psepick} item`, m)
//conn.sendButton( m.chat, `You Get 🎁chest weapons epic ${psepick} item`, wm, [[`again`, `.mancing`]], m)
        ...
        setTimeout(() => {
                     conn.sendText(m.chat, `${pemancing} Sepertinya dapat sesuatu..`, m)
                      }, 28000)
       setTimeout(() => {
                     conn.sendText(m.chat, `${pemancing} Menunggu`, m)
                      }, 8000)
       setTimeout(() => {
                     conn.sendText(m.chat, `${pemancing} Sedang Memancing...`, m)
                      }, 0)
        ...
        pengguna.nila += nila * 1
         ...
         pengguna.kepiting += kepiting * 1
           ...
           } else return conn.sendText(`*[❗] kamu tidak punya kail pancingan dan umpan 100 🎣*\n\nketik .buy pancingan 1 untuk buy\n\nketik .buy umpan 100 untuk buy`, m)


// conn.sendText(`*[❗] kamu tidak punya kail pancingan dan umpan 100 🎣*\n\nketik .buy pancingan 1 untuk buy\n\nketik .buy umpan 100 untuk buy`, m)
           break
	          ...
	          case 'easy':
                                  ...
                                  if (pancingan == 0 || umpan == 0) return conn.sendText(`*[❗] kamu tidak punya kail pancingan dan umpan 100 🎣*\n\nketik .buy pancingan 1 untuk buy\n\nketik .buy umpan 100 untuk buy`, m)
...
`.trim()
                                ...
                                setTimeout(() => {
                                conn.sendText(m.chat, `${pemancing} Yuk mancing mania level easy lagi`, m)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendText(m.chat, hsl, m)
                                }, 12000) 
                                setTimeout(() => {
                                conn.sendText(m.chat, `${pemancing} Menunggu`, m)
                                 }, 6000) 
                                 ...
                                 } else conn.sendText(m.chat, 'Minimal umpan kamu *100* untuk memancing level mudah', m)
                            } else conn.sendText(m.chat, 'Minimal pancingan kamu *Level 2* untuk memancing level mudah', m)
                       } else conn.sendText(m.chat, `*Sepertinya Anda Sudah Lelah*\n*Silahkan Istirahat Sejenak Sekitar* ${timersa}\n*Untuk Bisa Melanjutkan Memancing Lagi*`, m)
                 break
	          case 'normal':
...
`.trim()
                                ...
                                setTimeout(() => {
                                conn.sendText(m.chat, `${pemancing} Yuk mancing mania level normal lagi`, m)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendText(m.chat, hsls, m)
                                }, 12000) 
                                setTimeout(() => {
                                conn.sendText(m.chat, `${pemancing} Menunggu`, m)
                                 }, 6000) 
                                 ...
                                 pengguna.lastmancingeasy = new Date * 1
                                 } else conn.sendText(m.chat, 'Minimal umpan kamu *150* untuk memancing level normal', m)
                            } else conn.sendText(m.chat, 'Minimal pancingan kamu *Level 3* untuk memancing level normal', m)
...
`.trim()
                                ...
                                setTimeout(() => {
                                conn.sendText(m.chat, `${pemancing} Yuk mancing mania level hard lagi`, m)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendText(m.chat, hslsh, m)
                                }, 12000) 
                                setTimeout(() => {
                                conn.sendText(m.chat, `${pemancing} Menunggu`, m)
                                 }, 6000) 
                                 ...
                                 pengguna.lastmancingeasy = new Date * 1
                                 } else conn.sendText(m.chat, 'Minimal umpan kamu *200* untuk memancing level hard', m)
                            } else conn.sendText(m.chat, 'Minimal pancingan kamu *Level 4* untuk memancing level hard', m)
...
`.trim()
                                ...
                                setTimeout(() => {
                                conn.sendText(m.chat, `${pemancing} Yuk mancing mania level extreme lagi`, m)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendText(m.chat, hslse, m)
                                }, 12000) 
                                setTimeout(() => {
                                conn.sendText(m.chat, `${pemancing} Menunggu`, m)
                                 }, 6000) 
                                 ...
                                 pengguna.lastmancingeasy = new Date * 1
                                 } else conn.sendText(m.chat, 'Minimal umpan kamu *250* untuk memancing level extreme', m)
                            } else conn.sendText(m.chat, 'Minimal pancingan kamu *Level 5* untuk memancing level extreme', m)
                       } else conn.sendText(m.chat, `*Sepertinya Anda Sudah Lelah*\n*Silahkan Istirahat Sejenak Sekitar* ${timere}\n*Untuk Bisa Melanjutkan Memancing Lagi*`, m)
                 break
                       default:
                        return conn.sendText(m.chat, listMessage, m)
                }
        }
    } catch (e) {
        conn.sendText(m.chat, 'Error', m)
        console.log(e)
    }
}

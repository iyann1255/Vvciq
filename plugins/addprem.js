...
let handler = async (m, { conn, text, usedPrefix }) => {
  ...
  if (!text) return conn.reply(m.chat, `*❏ GET NUMBER*\n\n• ${usedPrefix}prem number|days\n*Example:* ${usedPrefix}prem 6289516947204|99\n\n• ${usedPrefix}prem @tag|days\n*Example:* ${usedPrefix}prem @6289516947204|99`, m)
  if (typeof db.data.users[hl[0]] == 'undefined') throw m.reply('Pengguna tidak ada didalam data base')
  ...
  conn.sendText(hl[0],`*❏ UPGRADE PREMIUM*\n\nBerhasil menambahkan akses premium kepada *@${hl[0].split('@')[0]}* selama *${hl[1]} hari*.\n\n*Premium : ${msToDate(global.db.data.users[hl[0]].premiumDate - now)}*`)
